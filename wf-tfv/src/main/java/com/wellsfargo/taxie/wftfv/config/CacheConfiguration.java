package com.wellsfargo.taxie.wftfv.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("wftfv");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("wftfv");
        ...
        config.getMapConfigs().put("com.wellsfargo.taxie.wftfv.domain.*", initializeDomainMapConfig(jHipsterProperties));
