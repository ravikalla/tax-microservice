    ...
    describe('Recipient Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'recipienthelper/api/recipients';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Recipient', () => {
                service.create(new Recipient(null)).subscribe(received => {
            ...
            it('should update a Recipient', () => {
                service.update(new Recipient(123)).subscribe(received => {
