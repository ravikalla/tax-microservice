...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("recipienthelper");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("recipienthelper");
        ...
        config.getMapConfigs().put("com.wellsfargo.taxie.recipienthelper.domain.*", initializeDomainMapConfig(jHipsterProperties));
